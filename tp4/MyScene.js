...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        //-------
        this.unitQuad = new MyUnitCubeQuad(this, this.textureMineTop, this.textureMineSide, this.textureMineSide, this.textureMineSide, this.textureMineSide, this.textureMineBottom);
            
        //-------Objects connected to MyInterface
        this.displayAxis = true;
        this.displayQuad = false;
        this.displayTang = false;
    ...
    display() {
        ...
        if(this.displayQuad){
            ...
            // Uncomment next line for NEAREST when magnifying, or 0.
