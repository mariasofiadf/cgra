...
export class MyScene extends CGFscene {
  ...
  display() {
    ...
    if (this.displayTriangle) this.triangle1.display();

    if (this.displayDiamond) this.diamond.display();

    if (this.displayParall) this.parall.display();

    if (this.displayBig) this.triangBig.display();

    if (this.displaySmall) this.triangleSmall.display();
